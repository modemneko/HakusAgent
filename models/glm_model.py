...
_GLOBAL_INSTANCE: GLMModel | None = None
    ...
    def __new__(cls) -> GLMModel:
        ...
        with _LOCK:
            if _GLOBAL_INSTANCE is None:
                ...
                api_key = BASE_CONFIG.get("GLM_API_KEY", "")
                if not api_key:
                ...
                logger.info(
                    f"GLMModel initialized: {instance.model_name} @ {instance.base_url}"
                )
        return _GLOBAL_INSTANCE
