import { GitBranch, Cpu, Wifi, Circle } from 'lucide-react'
...
/**
 * Codex-style bottom status bar — shows branch (run mode), token usage
 * totals for the active session, and connection state.
 */
export function BottomStatusBar() {
  ...
  return (
    <footer className="hk-statusbar app-region-drag">
      {/* Left: run mode + streaming (Codex style) */}
      ...
      {/* Right: tokens + connection (Codex tabular-nums) */}
