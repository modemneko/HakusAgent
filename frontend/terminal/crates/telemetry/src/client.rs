...
//!
//! The shipped default endpoint is `hakus_config::DEFAULT_TELEMETRY_ENDPOINT`,
...
///
/// The client is built through `hakus_release::platform_blocking_http_client_builder`,
...
fn post(endpoint: &str, app_version: &str, body: String) -> SendOutcome {
    let client = hakus_release::platform_blocking_http_client_builder()
        ...
        .user_agent(format!("hakus-telemetry/{app_version}"))
        .build();
