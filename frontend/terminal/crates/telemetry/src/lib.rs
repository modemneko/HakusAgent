//! Default-on, user-disableable anonymous product usage counting for Hakus.
//!
...
///
/// The previous version comes from `$HAKUS_HOME/telemetry/state.json` and
...
/// acquisition. If the actor, a wipe, or another Hakus process sharing
/// `HAKUS_HOME` holds it, the event is dropped immediately. This preserves
