...
//!
//! Everything lives under `$HAKUS_HOME/telemetry/`, created `0700`, with
//! every file `0600`:
//!
//! | file | role |
//! |---|---|
...
/// resolves to `hakus_config::DEFAULT_TELEMETRY_ENDPOINT` instead.
#[must_use]
...
/// what makes `hakus config set telemetry false` — an external write by
