...
//! fixture stands in for the interception endpoint, `HAKUS_HOME` is a fresh
...
const API_KEY_ENV: &str = "VF_HAKUS_API_KEY";
...
impl Fixture {
    ...
    /// `hakus-tui` runtime directly). `--no-project-config` precedes the
    ...
    fn run(&self, prompt: &str) -> std::process::Output {
        ...
        command
            ...
            .env("HAKUS_TELEMETRY", "false")
            .env("HAKUS_MCP_CONFIG", &self.mcp_config_path)
