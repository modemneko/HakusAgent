...
//!   HAKUS_CACHE_GUARD=1              Enable the guard (default: disabled)
//!   HAKUS_CACHE_GUARD_THRESHOLD=90   Hit rate threshold (0-100)
//!   HAKUS_CACHE_GUARD_STRICT=1       Fail on threshold violation (default: warn)
//!
//! Usage:
//!   HAKUS_CACHE_GUARD=1 cargo test --test cache_guard
//!   HAKUS_CACHE_GUARD=1 HAKUS_CACHE_GUARD_STRICT=1 cargo test --test cache_guard
...
const ENABLED_ENV: &str = "HAKUS_CACHE_GUARD";
const THRESHOLD_ENV: &str = "HAKUS_CACHE_GUARD_THRESHOLD";
const STRICT_ENV: &str = "HAKUS_CACHE_GUARD_STRICT";
