...
///
/// Fleet serializes this envelope onto the exact `hakus exec` argv. The
...
pub struct ToolExecutionState {
    ...
    /// Whether the enclosing host is the real headless `hakus exec`
    ...
    pub(crate) route_capabilities: hakus_config::route::RouteCapabilities,
...
impl ToolContext {
    ...
    pub fn new(workspace: impl Into<PathBuf>) -> Self {
        ...
        let notes_path = hakus_config::resolve_project_state_dir(&workspace, "notes.md")
            ...
            .1;
        let mcp_config_path = hakus_config::resolve_project_state_dir(&workspace, "mcp.json")
    ...
    pub fn with_options(
        ...
        Self {
            ...
            execution: Box::new(ToolExecutionState {
                ...
                route_capabilities: hakus_config::route::RouteCapabilities::default(),
                workshop_vars: None,
            }),
        }
    }
    ...
    pub fn with_skills_config(
        ...
        self.skills_scan_hakus_only = scan_hakus_only;
        self
    }
