...
//!
//! Hakus has exactly one To-do list. The model learns what is on it the
...
//!
//! 1. the `<hakus:fork_state>` block a newly forked sub-agent is handed,
...
//! - Item text can never close its wrapper: a closing tag in the `hakus:`
...
const ESCAPED_CLOSE_PREFIX: &str = "<\\/hakus:";
const CLOSE_PREFIX: &str = "</hakus:";
...
/// Render the To-do section of a `<hakus:fork_state>` block.
///
...
/// Neutralize any closing tag in the `hakus:` namespace so item content
