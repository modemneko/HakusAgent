...
impl FleetLedger {
    /// Open (or create) the ledger under `workspace/.hakus/fleet.jsonl`.
...
fn redact_fleet_event_text(value: &str) -> String {
    ...
    let redacted = inline_secret_assignment_pattern()
        ...
        .into_owned();
    let redacted = hakus_config::persistence::redact_secrets(&redacted);
    let redacted = redacted
        .split_whitespace()
        .map(hakus_config::persistence::redact_secrets)
        .collect::<Vec<_>>()
        .join(" ");
        ...
        ledger
            .append_event(FleetWorkerEvent {
                ...
                payload: FleetWorkerEventPayload::Artifact(FleetArtifactRef {
                    ...
                    path: PathBuf::from(".hakus/private/full-report.md"),
                ...
                .start_task_if_enqueued(
                    ...
                    vec![
                        ...
                        FleetWorkerEventPayload::Artifact(FleetArtifactRef {
                            ...
                            path: PathBuf::from(".hakus/fleet/run-1/task-a/worker-1.log"),
                            checksum: None,
