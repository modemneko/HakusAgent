...
pub const UI_THEME: UiTheme = UiTheme {
    ...
    surface_bg: Color::Rgb(HAKUS_BG_RGB.0, HAKUS_BG_RGB.1, HAKUS_BG_RGB.2),
    panel_bg: Color::Rgb(HAKUS_PANEL_RGB.0, HAKUS_PANEL_RGB.1, HAKUS_PANEL_RGB.2),
    elevated_bg: Color::Rgb(HAKUS_ELEVATED_RGB.0, HAKUS_ELEVATED_RGB.1, HAKUS_ELEVATED_RGB.2),
    composer_bg: Color::Rgb(HAKUS_COMPOSER_RGB.0, HAKUS_COMPOSER_RGB.1, HAKUS_COMPOSER_RGB.2),
    selection_bg: Color::Rgb(HAKUS_SELECTION_RGB.0, HAKUS_SELECTION_RGB.1, HAKUS_SELECTION_RGB.2),
    header_bg: Color::Rgb(HAKUS_CHROME_RGB.0, HAKUS_CHROME_RGB.1, HAKUS_CHROME_RGB.2),
    footer_bg: Color::Rgb(HAKUS_CHROME_RGB.0, HAKUS_CHROME_RGB.1, HAKUS_CHROME_RGB.2),
    text_dim: Color::Rgb(HAKUS_TEXT_DIM_RGB.0, HAKUS_TEXT_DIM_RGB.1, HAKUS_TEXT_DIM_RGB.2),
    text_hint: Color::Rgb(HAKUS_TEXT_HINT_RGB.0, HAKUS_TEXT_HINT_RGB.1, HAKUS_TEXT_HINT_RGB.2),
    text_muted: Color::Rgb(HAKUS_TEXT_MUTED_RGB.0, HAKUS_TEXT_MUTED_RGB.1, HAKUS_TEXT_MUTED_RGB.2),
    text_body: Color::Rgb(HAKUS_TEXT_BODY_RGB.0, HAKUS_TEXT_BODY_RGB.1, HAKUS_TEXT_BODY_RGB.2),
    text_soft: Color::Rgb(HAKUS_TEXT_SOFT_RGB.0, HAKUS_TEXT_SOFT_RGB.1, HAKUS_TEXT_SOFT_RGB.2),
    border: Color::Rgb(HAKUS_BORDER_RGB.0, HAKUS_BORDER_RGB.1, HAKUS_BORDER_RGB.2),
    accent_primary: Color::Rgb(HAKUS_ACTION_RGB.0, HAKUS_ACTION_RGB.1, HAKUS_ACTION_RGB.2),
    accent_secondary: Color::Rgb(HAKUS_ACCENT_SECONDARY_RGB.0, HAKUS_ACCENT_SECONDARY_RGB.1, HAKUS_ACCENT_SECONDARY_RGB.2),
    accent_action: Color::Rgb(HAKUS_HUMAN_RGB.0, HAKUS_HUMAN_RGB.1, HAKUS_HUMAN_RGB.2),
    error_fg: Color::Rgb(HAKUS_ERROR_RGB.0, HAKUS_ERROR_RGB.1, HAKUS_ERROR_RGB.2),
    error_hover: Color::Rgb(255, 153, 178),
    error_surface: Color::Rgb(54, 25, 39),
    error_border: Color::Rgb(HAKUS_ERROR_RGB.0, HAKUS_ERROR_RGB.1, HAKUS_ERROR_RGB.2),
    error_text: Color::Rgb(255, 220, 231),
    warning: Color::Rgb(HAKUS_WARNING_RGB.0, HAKUS_WARNING_RGB.1, HAKUS_WARNING_RGB.2),
    success: Color::Rgb(HAKUS_WORKING_GREEN_RGB.0, HAKUS_WORKING_GREEN_RGB.1, HAKUS_WORKING_GREEN_RGB.2),
    info: Color::Rgb(HAKUS_ACTION_RGB.0, HAKUS_ACTION_RGB.1, HAKUS_ACTION_RGB.2),
    mode_agent: Color::Rgb(HAKUS_ACTION_RGB.0, HAKUS_ACTION_RGB.1, HAKUS_ACTION_RGB.2),
    mode_yolo: Color::Rgb(HAKUS_ERROR_RGB.0, HAKUS_ERROR_RGB.1, HAKUS_ERROR_RGB.2),
    mode_plan: Color::Rgb(HAKUS_HUMAN_RGB.0, HAKUS_HUMAN_RGB.1, HAKUS_HUMAN_RGB.2),
    mode_operate: Color::Rgb(HAKUS_ACCENT_SECONDARY_RGB.0, HAKUS_ACCENT_SECONDARY_RGB.1, HAKUS_ACCENT_SECONDARY_RGB.2),
    permission_ask: Color::Rgb(HAKUS_HUMAN_RGB.0, HAKUS_HUMAN_RGB.1, HAKUS_HUMAN_RGB.2),
    permission_auto_review: Color::Rgb(232, 183, 215),
    permission_full_access: Color::Rgb(HAKUS_ERROR_RGB.0, HAKUS_ERROR_RGB.1, HAKUS_ERROR_RGB.2),
    status_ready: Color::Rgb(HAKUS_TEXT_MUTED_RGB.0, HAKUS_TEXT_MUTED_RGB.1, HAKUS_TEXT_MUTED_RGB.2),
    status_working: Color::Rgb(HAKUS_WORKING_GREEN_RGB.0, HAKUS_WORKING_GREEN_RGB.1, HAKUS_WORKING_GREEN_RGB.2),
    status_warning: Color::Rgb(HAKUS_HUMAN_RGB.0, HAKUS_HUMAN_RGB.1, HAKUS_HUMAN_RGB.2),
    diff_added_fg: Color::Rgb(HAKUS_WORKING_GREEN_RGB.0, HAKUS_WORKING_GREEN_RGB.1, HAKUS_WORKING_GREEN_RGB.2),
    diff_deleted_fg: Color::Rgb(HAKUS_ERROR_RGB.0, HAKUS_ERROR_RGB.1, HAKUS_ERROR_RGB.2),
    diff_added_bg: Color::Rgb(24, 48, 43),
    diff_deleted_bg: Color::Rgb(54, 25, 39),
    tool_running: Color::Rgb(HAKUS_ACCENT_SECONDARY_RGB.0, HAKUS_ACCENT_SECONDARY_RGB.1, HAKUS_ACCENT_SECONDARY_RGB.2),
    tool_success: Color::Rgb(HAKUS_WORKING_GREEN_RGB.0, HAKUS_WORKING_GREEN_RGB.1, HAKUS_WORKING_GREEN_RGB.2),
    tool_failed: Color::Rgb(HAKUS_ERROR_RGB.0, HAKUS_ERROR_RGB.1, HAKUS_ERROR_RGB.2),
};
...
/// schemes, etc.) rather than Hakus brand RGB.
...
impl ThemeId {
    ...
    pub const fn display_name(self) -> &'static str {
        match self {
            Self::System => "System",
            Self::Terminal => "Terminal",
            Self::Whale => "Hakus Night",
            Self::WhaleLight => "Hakus Light",
            Self::Grayscale => "Grayscale",
            Self::CatppuccinMocha => "Catppuccin Mocha",
            Self::TokyoNight => "Tokyo Night",
            Self::Dracula => "Dracula",
    ...
    pub const fn tagline(self) -> &'static str {
        match self {
            ...
            Self::Whale => "Ink, lavender, lilac, gold, and mint — the Hakus desktop language",
            Self::WhaleLight => "Paper, lavender, lilac, gold, and mint — the Hakus desktop language",
...
mod tests {
    ...
    #[test]
    fn whale_pair_uses_hakus_semantic_grammar() {
