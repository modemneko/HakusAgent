...
pub struct ProjectContext {
    ...
    /// Auto-discovered rules from `.hakus/rules/` / `.claude/rules/`.
    ...
    /// Rendered `.hakus/constitution.json` authority block, if present.
    /// Hakus-specific repo authority/prioritization policy — distinct from
...
impl ProjectContext {
    ...
    ///
    /// The Hakus repo constitution (`.hakus/constitution.json`), when
