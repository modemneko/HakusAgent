...
///
/// A key held in the Hakus secret store / OS keyring is deliberately not
...
mod tests {
    ...
    fn moonshot_endpoint_env_lock() -> [crate::test_support::EnvVarGuard; 4] {
        [
            crate::test_support::EnvVarGuard::remove("HAKUS_BASE_URL"),
    ...
    fn turn_complete_kimi_code_receipt_accrues_no_dollars() {
        let _lock = crate::test_support::lock_test_env();
        let _env = moonshot_endpoint_env_lock();
        // Pins the exact decision the `EngineEvent::TurnCompleted` arm makes:
    ...
    fn dispatched_moonshot_receipt_owns_billing_over_any_later_config_state() {
        ...
        let _generic = crate::test_support::EnvVarGuard::remove("HAKUS_BASE_URL");
    ...
    fn xai_oauth_and_api_key_routes_stay_distinct() {
        ...
        let _home = crate::test_support::EnvVarGuard::set("HAKUS_HOME", &owned_home);
        ...
        #[cfg(windows)]
        crate::external_credentials::secure_hakus_owned_windows_path(
        ...
        .expect("write Hakus-owned xAI credential");
        #[cfg(unix)]
        {
        ...
        #[cfg(windows)]
        crate::external_credentials::secure_hakus_owned_windows_path(&owned_path, false)
            .expect("secure owned credential file");
    ...
    /// The release blocker: a MiniMax key saved through `hakus auth set`
