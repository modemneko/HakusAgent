...
{"event":"tool_call_finished","turn_id":"turn-secret-1","tool_name":"exec_shell","exit_code":127,"stderr":"bash: rg: command not found"}
{"event":"tool_call_finished","turn_id":"turn-secret-1","tool_name":"exec_shell","exit_code":2,"stderr":"command failed with exit code 2"}
{"event":"tool_call_finished","turn_id":"turn-secret-1","tool_name":"web_search","error":"DNS resolution failed for api.example.test"}
{"event":"tool_call_finished","turn_id":"turn-secret-1","tool_name":"apply_patch","error":"Permission denied by sandbox: read-only filesystem"}
{"event":"tool_call_finished","turn_id":"turn-secret-1","tool_name":"exec_shell","error":"request timed out after 30s"}
{"event":"tool_call_finished","turn_id":"turn-secret-1","tool_name":"task_shell_wait","error":"background job timed out"}
{"event":"tool_call_finished","turn_id":"turn-secret-1","tool_name":"mcp_tool","error":"missing field: tool arguments"}
{"event":"turn_completed","turn_id":"turn-secret-1","status":"completed"}
...
{"event":"tool_call_finished","turn_id":"turn-secret-1","tool_name":"read_file","timestamp":"2026-06-25T12:34:56Z","error":"No such file or directory: /Users/alice/secret/project/.env"}
"#;
    ...
    fn successful_content_does_not_create_unknown_failure() {
        let jsonl = r#"
{"event":"turn_started","turn_id":"turn-secret-1"}
{"event":"tool_call_finished","turn_id":"turn-secret-1","tool_name":"exec_shell","success":true,"content":"command output mentioning error budgets is still normal content"}
{"event":"turn_completed","turn_id":"turn-secret-1","status":"completed","message":"done"}
"#;
    ...
    fn empty_error_field_is_not_a_failure_signal() {
        let jsonl = r#"
{"event":"tool_call_finished","success":true,"error":"","stderr":""}
"#;
    ...
    fn nested_generic_fields_do_not_shadow_source_handles() {
        let jsonl = r#"
{"event":"tool_call_finished","turn_id":"turn-real","tool_name":"exec_shell","success":false,"payload":{"id":"nested-id","name":"nested-name","error":"nested error"}}
"#;
    ...
    fn deeply_nested_error_field_is_ignored() {
        let jsonl = r#"
{"event":"tool_call_finished","payload":{"a":{"b":{"c":{"d":{"e":{"error":"too deep"}}}}}}}
"#;
