...
pub(crate) fn safe_error_text(raw: &str) -> String {
    let redacted = hakus_config::persistence::redact_secrets(raw);
...
mod tests {
    ...
    fn hostile_error_text_never_publishes_the_hostile_part() {
        ...
        let hostile: Vec<String> = vec![
            ...
            "cannot read C:\\Users\\someone\\.hakus\\config.toml".to_string(),
            format!("cannot read {home}/.hakus/config.toml"),
