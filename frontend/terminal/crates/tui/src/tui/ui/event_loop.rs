...
pub async fn run_tui(
    ...
    if use_alt_screen {
        ...
        // Windows also suppresses Hakus's own verbose CLI logger while
...
pub(crate) async fn run_event_loop(
    ...
    loop {
        ...
        if done && let Ok(Some(notice)) = version_check.take().unwrap().await {
            ...
            let install = hakus_release::current_install_method();
            ...
            loop {
                ...
                match event {
                    ...
                    EngineEvent::TurnCompleted {
                        ...
                        // not use hooks.
                        {
                            let telemetry = hakus_telemetry::session_counters();
                            telemetry.bump(hakus_telemetry::Counter::Turns);
                    ...
                    EngineEvent::TokenUsage {
                        ...
                        // are driven by the cumulative `TurnCompleted` usage;
                    ...
                    >= TERMINAL_INPUT_RECOVERY_COOLDOWN
            {
                ...
                match terminal_input.restart_detached() {
                    ...
                    Err(err) => {
                        ...
                        app.push_status_toast(
                            "Terminal input stalled; recovery failed. Restart Hakus if keys stop responding.",
                            StatusToastLevel::Error,
                            None,
                        );
                    }
        ...
        if let Some(evt) = maybe_terminal_event {
            ...
            if key.code == KeyCode::Char('k') && key.modifiers.contains(KeyModifiers::CONTROL) {
                ...
                hakus_telemetry::session_counters()
                    .bump(hakus_telemetry::Counter::CommandPaletteOpen);
