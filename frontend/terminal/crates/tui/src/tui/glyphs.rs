//! Hakus's terminal glyph charter.
//!
...
//! Hakus anchor: it marks the active speaker or current human choice.
...
/// Reduce a single Hakus-authored decorative glyph to narrow ASCII.
