...
const BACKLOG_RECEIPT_PATH_ENV: &str = "HAKUS_TEST_PERSISTENCE_BACKLOG_RECEIPT_PATH";
const BACKLOG_SOURCE_SHA_ENV: &str = "HAKUS_TEST_PERSISTENCE_BACKLOG_SOURCE_SHA";
const BACKLOG_SOURCE_DIRTY_ENV: &str = "HAKUS_TEST_PERSISTENCE_BACKLOG_SOURCE_DIRTY";
const BACKLOG_RUSTC_VERSION_ENV: &str = "HAKUS_TEST_PERSISTENCE_BACKLOG_RUSTC_VERSION";
const BACKLOG_CARGO_VERSION_ENV: &str = "HAKUS_TEST_PERSISTENCE_BACKLOG_CARGO_VERSION";
...
fn persistence_backlog_receipt(
    ...
    serde_json::json!({
        "document_kind": "hakus.persistence_backlog_receipt",
        "schema_version": 2,
