...
use hakus_config::{UntrustedDraftParse, UserConstitution, user_constitution::MAX_NOTES_LEN};
...
fn drafting_system_prompt() -> String {
    concat!(
        "You are helping a new Hakus user draft their user constitution: durable, ",
...
mod tests {
    ...
    use hakus_config::AutonomyPreference;
    use hakus_config::user_constitution::MAX_NOTES_LEN;
