...
//! `$HAKUS_HOME/file-frecency.jsonl` (normally
//! `~/.hakus/file-frecency.jsonl`) so frecency survives restarts.
//!
...
fn default_path() -> Option<PathBuf> {
    ...
    // append to a developer's real Hakus home. Integration and release QA
    // processes use an explicit isolated HAKUS_HOME instead.
    #[cfg(test)]
    {
        None
    }
