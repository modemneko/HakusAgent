...
pub const KIMI_CODE_MEMBERSHIP_PLAN_CONSOLE_URL: &str =
    hakus_config::provider::KIMI_CODE_MEMBERSHIP_PLAN_CONSOLE_URL;
...
pub const DEFAULT_OLLAMA_CLOUD_BASE_URL: &str = hakus_config::provider::OLLAMA_CLOUD_BASE_URL;
...
pub use hakus_config::OPENCODE_GO_CHAT_MODELS;
