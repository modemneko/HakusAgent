...
//! layer of the Hakus system prompt.
//!
...
//! `cargo test -p hakus-tui --bin hakus-tui prompts` after edits.
//!
...
pub const BASE_PROMPT: &str = r#"## Hakus

You are Hakus, an agent working alongside the user to carry out their
...
pub const HEADLESS_BASE_PROMPT: &str = r#"## Hakus

You are Hakus, assisting someone.
...
/// rely on the summary line + `<hakus:subagent.done>` sentinel.
