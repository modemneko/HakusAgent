...
//!
//! If bwrap is not executable, Hakus reports no Linux OS sandbox and runs
...
pub fn build_bwrap_command(
    ...
    // writable root cannot make .hakus/.deepseek exceptions writable.
...
mod tests {
    ...
    fn workspace_write_mounts_every_safe_root_and_protects_read_only_descendants() {
        ...
        let protected = workspace.join(".hakus");
