...
// owned by `hakus-core`. Existing transports and response decoders do not
...
mod tests {
    ...
    fn historical_tui_request_path_is_the_core_request_type() {
        assert_eq!(
            ...
            TypeId::of::<hakus_core::request::MessageRequest>()
        );
        ...
        let via_core_path: hakus_core::request::MessageRequest = via_tui_path.clone();
        assert_eq!(
