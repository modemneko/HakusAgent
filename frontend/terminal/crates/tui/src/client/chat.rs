...
const SYSTEM_PROMPT_DUMP_ENV: &str = "HAKUS_DUMP_SYSTEM_PROMPT";
const SYSTEM_PROMPT_DUMP_BEGIN: &str = "<<<HAKUS_SYSTEM_PROMPT_BEGIN>>>";
const SYSTEM_PROMPT_DUMP_END: &str = "<<<HAKUS_SYSTEM_PROMPT_END>>>";
...
/// users on `RUST_LOG=hakus_tui=debug` can see how much of their input
...
mod mistral_reasoning_tests {
    ...
    #[test]
    fn mistral_effort_wire_value_covers_hakus_tiers() {
