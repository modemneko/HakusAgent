...
**Recommended Location**: `{project_path}/skills/research/web-search`

Extract this skill package to the above path in your project.

**Reference Scripts**: Example test scripts are available in the `{project_path}/skills/research/web-search/scripts/` directory for quick testing and reference. See `{project_path}/skills/research/web-search/scripts/web_search.ts` for a working example.
