...
- **Design intelligence data**: Read from `skills/design/extensions/ui-ux-pro-max/assets/data/` when you need palettes, patterns, or UI/UX heuristics.
- **Upstream reference**: If you need more phrasing/examples, consult `skills/design/extensions/ui-ux-pro-max/references/upstream-skill-content.md`.
...
```bash
python3 skills/design/extensions/ui-ux-pro-max/scripts/design_system.py --help
```
